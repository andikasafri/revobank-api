...
Revises: add_bills_table
Create Date: 2025-03-28 19:23:29.428663
...
def downgrade():
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('transaction_categories_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.ForeignKeyConstraint(['category_id'], ['transaction_categories.id'], name='fk_transactions_category', ondelete='SET NULL'),
